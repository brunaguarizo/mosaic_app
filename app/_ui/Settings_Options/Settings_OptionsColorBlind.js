...
import styles from "./Settings_OptionsColorBlind.module.css";
import Toggle from "../Toggle/Toggle";

const SettingsOptionsColorBlind = () => {
    const [colourBlindToggle, setColourBlindToggle] = React.useState(true);
    ...
    return (
        <div className={styles.settingsContainer}>
            ...
            <div className={styles.settingsList}>
                ...
                <Toggle
                    isToggled={colourBlindToggle}
                    setIsToggled={handleColourBlindToggle}
                    toggledClassName='toggledColorBlind'
                />
            </div>
            <div className={styles.settingsList}>
                <div className={styles.left}>
...
export default SettingsOptionsColorBlind;
