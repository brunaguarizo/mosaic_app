...
export default function ProjectName() {
    ...
    const handleNext = () => {
        router.replace("/CreateProject/Step10");
    };
    const handleLater = () => {
    ...
    const options = [
        "A real-world brand or concept",
        "A fictional startup",
        "An abstract/fantasy idea",
    ];
    ...
    return (
        <div className={styles.container}>
            ...
            />
            {/* progress */}
            <ProgressBar CompletionAmount={90} />
            {/* Image */}
            <img
                className={styles.image}
                src='/createproject/image_11.png'
                quality={100}
                width={361}
                height={460}
                alt='Graphics'
            ...
            <div className={styles.content}>
                <p className={styles.title}>Do you prefer working with:</p>
